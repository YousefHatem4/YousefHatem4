...
I'm a **motivated Frontend Engineer** with a strong foundation in modern web development, passionate about creating responsive, user-friendly applications that deliver exceptional experiences. Currently pursuing my Bachelor's in Computer Science at Misr University for Science and Technology (GPA: 3.63).
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=yousefhatem24&show_icons=true&theme=radical&hide_border=true&count_private=true)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=yousefhatem24&layout=compact&theme=radical&hide_border=true)

![GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=yousefhatem24&theme=radical&hide_border=true)
...
Misr University for Science and Technology | 2022 - 2026  
...
### 🚀 Elevvo Pathways Internship - Frontend Developer
**July 2025 - August 2025**

- Built collapsible sidebar layout with smooth expand/collapse functionality using HTML, CSS, and JavaScript
- Developed responsive contact form with full validation, hover effects, and mobile-first design
- Created TaskFlow landing page using React, Tailwind CSS & Framer Motion with animations and testimonials
- Integrated live weather API for real-time updates with sleek UI built in HTML, Bootstrap, and JavaScript

### 🚀 DevWave Internship - Frontend Developer
**July 2025 - August 2025**

**Phase 1 Achievements:**
- Delivered pixel-perfect landing page using pure HTML & CSS with semantic structure and responsive design
- Mastered utility-first styling with Tailwind CSS for scalable layouts
- Developed authentication UI (Login/Register system) using Bootstrap 5 with mobile-first approach

**Phase 2 Achievements:**
- Built fully responsive webpage in 1 day using HTML, CSS, and Tailwind CSS
- Produced comprehensive video tutorials (10-15 min) on API fetching methods and ES6 features
- Collaborated on food ordering system with React.js frontend and Django backend integration
...
- **Styling:** Tailwind CSS, Bootstrap, Material UI, SCSS, Framer Motion
- **Concepts:** Responsive Design, Component Architecture, State Management, API Integration

### Programming Fundamentals
- **Languages:** C++ (Fundamentals)
...
- **Design:** Mobile-first approach, Accessibility standards

### Languages
- **Arabic:** Native - Full working proficiency
- **English:** High proficiency in understanding and writing

---

## 💡 Currently Working On

- 🔨 Expanding full-stack development capabilities with backend technologies
- 📱 Building more complex React applications with advanced state management
- 🎨 Enhancing UI/UX design skills and animation techniques
- 🚀 Contributing to open-source projects and collaborating with developers
- 🐳 Learning Docker and containerization for modern deployment

---

## 📫 Let's Connect!

I'm always interested in collaborating on exciting projects, discussing new opportunities, or connecting with fellow developers!
